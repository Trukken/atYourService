                        ...
                        <div class="card-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="md-form">
                                    ...
                                    <input type="password" id="orangeForm-pass-conf" name="password_confirmation" class="form-control">
                                    <label for="orangeForm-pass-conf" onclick="className='active'; document.querySelector('.password_confirmation-input').focus()">Confirmation password</label>
                                </div>
